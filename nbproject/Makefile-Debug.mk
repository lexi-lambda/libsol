...
${OBJECTDIR}/solop.o: solop.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/solop.o solop.c

${OBJECTDIR}/soltypes.o: soltypes.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/soltypes.o soltypes.c

${OBJECTDIR}/soltoken.o: soltoken.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/soltoken.o soltoken.c

${OBJECTDIR}/runtime.o: runtime.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/runtime.o runtime.c

${OBJECTDIR}/solar.o: solar.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/solar.o solar.c

${OBJECTDIR}/sol.o: sol.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sol.o sol.c

${OBJECTDIR}/sollist.o: sollist.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sollist.o sollist.c

${OBJECTDIR}/solfunc.o: solfunc.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/solfunc.o solfunc.c
